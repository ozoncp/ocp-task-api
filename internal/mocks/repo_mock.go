...
func (m *MockRepo) DescribeTask(arg0 context.Context, arg1 uint64) (*models.Task, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) ListTasks(arg0 context.Context, arg1, arg2 uint64) ([]models.Task, error) {
	m.ctrl.T.Helper()
